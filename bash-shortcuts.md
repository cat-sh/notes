...
The ability to edit the command line using shortcuts is provided by the GNU Readline library.

These shortcuts are used in other *nix applications besides bash that use Readline.

By default it uses emacs keybindings, although it can be configured to use vi.
